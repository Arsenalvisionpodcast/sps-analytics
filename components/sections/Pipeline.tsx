...
const steps = [
  {
    ...
    description:
      'SPS connects directly to thousands of retailer and distributor portals, EDI systems, SFTP feeds, and data lakes. No more manual downloads, no missed updates.',
    icon: (
